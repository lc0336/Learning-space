...
public class BillCheckExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<Tuple3<String, String, Long>> appStream = env.fromElements(
                Tuple3.of("order-1", "app", 1000L),
                Tuple3.of("order-2", "app", 2000L)
        );

        DataStreamSource<Tuple4<String, String, String, Long>> thirdStream = env.fromElements(
                Tuple4.of("order-1", "third-party", "success", 3000L),
                Tuple4.of("order-3", "third-party", "success", 4000L)
        );

        // 来自 app 的支付日志
        SingleOutputStreamOperator<Tuple3<String, String, Long>> appStreams =
                appStream.assignTimestampsAndWatermarks(WatermarkStrategy.<Tuple3<String, String, Long>>forMonotonousTimestamps()
        ...
        SingleOutputStreamOperator<Tuple4<String, String, String, Long>> thirdpartStream =
                thirdStream.assignTimestampsAndWatermarks(WatermarkStrategy.<Tuple4<String, String, String, Long>>forMonotonousTimestamps()
        ...
        appStreams.connect(thirdpartStream)
